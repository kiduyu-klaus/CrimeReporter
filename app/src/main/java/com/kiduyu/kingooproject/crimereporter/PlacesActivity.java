...
public class PlacesActivity extends Activity implements MapEventsReceiver, MapView.OnFirstLayoutListener {
    MapView map;
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		*/
        ...
        Drawable poiIcon = ResourcesCompat.getDrawable(getResources(), R.drawable.ic_marker, null);
        if (pois != null) {
            for (POI poi : pois) {
